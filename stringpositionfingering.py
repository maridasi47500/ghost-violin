...
fingering_map={'g': {'string': 'G', 'position': 'I', 'finger': '0'}, 'a': {'string': 'G', 'position': 'I', 'finger': '1'}, 'b': {'string': 'G', 'position': 'I', 'finger': '2'}, "c'": {'string': 'G', 'position': 'I', 'finger': '3'}, "d'": {'string': 'D', 'position': 'I', 'finger': '0'}, "e'": {'string': 'D', 'position': 'I', 'finger': '1'}, "fis'": {'string': 'D', 'position': 'I', 'finger': '2'}, "g'": {'string': 'D', 'position': 'I', 'finger': '3'}, "a'": {'string': 'A', 'position': 'I', 'finger': '0'}, "b'": {'string': 'A', 'position': 'I', 'finger': '1'}, "c''": {'string': 'A', 'position': 'I', 'finger': '2'}, "d''": {'string': 'A', 'position': 'I', 'finger': '3'}, "e''": {'string': 'E', 'position': 'I', 'finger': '0'}, "fis''": {'string': 'E', 'position': 'I', 'finger': '1'}, "g''": {'string': 'E', 'position': 'I', 'finger': '2'}, "a''": {'string': 'E', 'position': 'III', 'finger': '1'}, "b''": {'string': 'E', 'position': 'III', 'finger': '2'}, "c'''": {'string': 'E', 'position': 'III', 'finger': '3'}, "d'''": {'string': 'E', 'position': 'III', 'finger': '4'}, "e'''": {'string': 'E', 'position': 'III', 'finger': '4'}}
...
def replace_placeholders(match):
    ...
    if key not in fingering_map:
        try:
            ...
            print("second key",key,mysecondkey)
